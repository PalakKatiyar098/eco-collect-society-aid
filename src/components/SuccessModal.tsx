    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-md text-center">
        <div className="space-y-6 py-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-gray-600">
              {isEWaste 
                ...
                : 'Your biomedical waste pickup has been booked and paid for.'
              }
            </p>
          </div>
              ...
              <li className="flex items-start gap-2">
                ...
                <span>
                  {isEWaste 
                    ...
                    : 'Disposal certificate will be sent via email'
                  }
                </span>
              </li>
            </ul>
          ...
          <Button 
            onClick={onClose} 
            className={`w-full ${isEWaste ? 'bg-primary hover:bg-primary/90' : 'bg-orange-500 hover:bg-orange-600'} text-white`}
          >
            Done
          </Button>
        </div>
